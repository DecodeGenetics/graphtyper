...
template std::vector<KmerLabel> query_index_for_first_kmer(seqan::IupacString const & read, PHIndex const & ph_index);
...
// Explicit instantation
template std::vector<std::vector<KmerLabel>> query_index_hamming_distance1_without_index<seqan::Dna5String>(
  seqan::Dna5String const &, gyper::PHIndex const &);
template std::vector<std::vector<KmerLabel>> query_index_hamming_distance1_without_index<seqan::IupacString>(
  seqan::IupacString const &, gyper::PHIndex const &);
